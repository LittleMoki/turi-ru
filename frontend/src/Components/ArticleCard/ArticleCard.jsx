...
export const ArticleCard = ({photo,country,new_date,view,url,type,firsttext,title,style=''}) => {
    return (
        <div className={`bg-white rounded-2xl shadow-lg ${style}`}>
            <div className='overflow-hidden relative rounded-2xl'>
                ...
                <div
                    className='absolute bottom-0 left-0 w-full bg-black/70 text-white py-[5px] px-[15px] flex justify-between items-center flex-wrap gap-2'>
