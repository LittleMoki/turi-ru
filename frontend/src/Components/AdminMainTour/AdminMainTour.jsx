				...
				<form className='flex flex-col gap-3' onSubmit={handleSubmit}>
					...
					<Select
						...
						onSelectionChange={keys =>
							handleInputChange('typeId', keys.values().next().value)
						}
					>
						{TourTypeBase.map(el => (
					...
					<Select
						...
						onSelectionChange={keys =>
							handleInputChange('teamId', keys.values().next().value)
						}
					>
						{team.map(el => (
							<SelectItem key={el.id} value={el.id.toString()}>
								...
								<CardBody>
									...
									>
										<div className='flex flex-col gap-3'>
											...
											>
												<div className='max-h-[300px] overflow-y-auto flex flex-col gap-3 overflow-x-hidden'>
									...
									<form className='flex flex-col gap-3' onSubmit={handleSubmit}>
										...
										<div className='grid md:grid-cols-2 gap-3'>
											<div className='flex flex-col gap-3'>
												...
												>
													<div className='max-h-[350px] overflow-y-auto flex flex-col gap-3 overflow-x-hidden'>
												...
												{formData.tourtoday.map((el, i) => (
													...
													>
														...
														<div className='flex flex-col gap-3'>
															...
															>
																<div className='min-h-[150px] overflow-y-auto flex flex-col gap-3 overflow-x-hidden'>
